...
def analyze_market(symbol, tf):
    try:
        ...
        if price_close < fib618 and (rsi < 40 or ema_fast < ema_slow) and distance < 0.03:
            msg = (
            ...
            print(f"✅ Signal LONG envoyé : {symbol} ({tf})")

        elif price_close > fib618 and (rsi > 60 or ema_fast > ema_slow) and distance < 0.03:
            msg = (
            ...
            send_telegram_message(msg)
            print(f"✅ Signal SHORT envoyé : {symbol} ({tf})")
